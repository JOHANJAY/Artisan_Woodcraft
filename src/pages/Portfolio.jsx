...
const projects = [
  ...
  },
  {
    ...
    description: 'Set of 6 handcrafted dining chairs with comfortable upholstered seats.',
    image: 'https://images.pexels.com/photos/1350789/pexels-photo-1350789.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750',
    category: 'seating',
  ...
  },
  {
    ...
    image: 'https://images.pexels.com/photos/6508175/pexels-photo-6508175.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750',
    category: 'storage',
  ...
  },
  {
    ...
    description: 'Handcrafted wooden desk chair designed for comfort and support.',
    image: 'https://images.pexels.com/photos/116910/pexels-photo-116910.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750',
    category: 'seating',
  ...
  },
  {
    ...
    description: 'Functional kitchen island with butcher block top and storage.',
    image: 'https://images.pexels.com/photos/6969197/pexels-photo-6969197.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750',
    category: 'custom',
  ...
  },
  {
    id: 9,
    title: 'Wine Cabinet',
    description: 'Temperature-controlled wine storage cabinet with display area.',
    image: 'https://images.pexels.com/photos/2079438/pexels-photo-2079438.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750',
    category: 'storage',
    ...
    <PageTransition>
      <div className="bg-softwhite">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-slate mb-8">
                Explore our collection of handcrafted furniture pieces,
                each one a testament to quality craftsmanship and timeless design.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="section-padding">
          <div className="container mx-auto px-4">
            {/* Filter Categories */}
            <div className="flex flex-wrap justify-center gap-4 mb-12" ref={ref}>
            ...
            {filteredProjects.length === 0 && (
              <div className="text-center py-12">
                <p>No projects found in this category. Please check back soon!</p>
              </div>
            )}
          </div>
        </section>
            ...
            <div>
              ...
              <div className="p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div>
                    ...
                    <ul className="space-y-2 text-slate">
                      <li><strong>Dimensions:</strong> {selectedProject.dimensions}</li>
                      <li><strong>Materials:</strong> {selectedProject.materials}</li>
                      <li><strong>Finish Options:</strong> {selectedProject.finishOptions}</li>
                      <li><strong>Delivery Time:</strong> {selectedProject.deliveryTime}</li>
                    </ul>
                  </div>
                  <div>
                    <h4 className="text-lg font-medium mb-2">Customization Options</h4>
                    <p className="text-slate">
                      This design can be customized to fit your specific needs and preferences.
                      Adjustments to dimensions, materials, and finishes are available.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex justify-between items-center mt-8">
                  <p className="text-slate">
                    Like what you see? Request a similar piece or your own custom design.
                  </p>
